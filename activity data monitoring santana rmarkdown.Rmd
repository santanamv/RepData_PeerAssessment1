...
IntervalPlot + geom_line(size = 1.5, alpha = 0.75) + scale_color_manual(values=c("darkseagreen4","cadetblue4")) + labs(title = "Weekday & Weekend Daily Average Steps Activity Pattern", x= "5-minute Time Interval", y = "Average Steps") + theme(plot.title = element_text(hjust = 0.5))
